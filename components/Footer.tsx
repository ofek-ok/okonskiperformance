...
// Replace these placeholders with your verified social media profile URLs:
// =========================================================================
export const SOCIAL_LINKS = {
  instagram: "https://instagram.com/[OKONSKI_PERFORMANCE_INSTAGRAM]",
  facebook: "https://facebook.com/[OKONSKI_PERFORMANCE_FACEBOOK]",
  tiktok: "https://tiktok.com/@[OKONSKI_PERFORMANCE_TIKTOK]",
  linkedin: "https://linkedin.com/company/[OKONSKI_PERFORMANCE_LINKEDIN]",
};
    ...
    <footer className="bg-primary border-t border-white/5 pt-16 pb-12 relative overflow-hidden" aria-label="תחתית האתר">
      <div className="container mx-auto px-6 max-w-7xl relative z-10">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center md:items-start mb-14 gap-8">
          ...
          {/* Social Links — Minimal, clean, accessible */}
