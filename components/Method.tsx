  ...
  return (
    <section id="services" className="py-20 sm:py-32 bg-charcoal">
      <div className="container mx-auto px-6 max-w-6xl">
        ...
        {/* Use Cases - Clean Cards Layout */}
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          
          {/* Card 1 */}
          <div className="group relative bg-steel/30 border border-white/5 rounded-2xl p-10 hover:bg-steel/60 hover:border-brand/30 transition-all duration-300">
            <div className="text-brand/20 font-barlow text-8xl font-black absolute -top-4 -right-2 pointer-events-none group-hover:text-brand/40 transition-colors">01</div>
          ...
          {/* Card 2 */}
          <div className="group relative bg-steel/30 border border-white/5 rounded-2xl p-10 hover:bg-steel/60 hover:border-brand/30 transition-all duration-300">
            <div className="text-brand/20 font-barlow text-8xl font-black absolute -top-4 -right-2 pointer-events-none group-hover:text-brand/40 transition-colors">02</div>
          ...
          {/* Card 3 */}
          <div className="group relative bg-steel/30 border border-white/5 rounded-2xl p-10 hover:bg-steel/60 hover:border-brand/30 transition-all duration-300">
            <div className="text-brand/20 font-barlow text-8xl font-black absolute -top-4 -right-2 pointer-events-none group-hover:text-brand/40 transition-colors">03</div>
